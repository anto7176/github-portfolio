...
const int MATRIX_A = 1;
const int MATRIX_B = 0;

// Values are 260/330/400
const int ACC_THRESHOLD_LOW = 300;
const int ACC_THRESHOLD_HIGH = 360;

// Matrix
const int PIN_DATAIN = 5;
const int PIN_CLK = 4;
...
// Rotary Encoder
const int PIN_ENC_1 = 3;
const int PIN_ENC_2 = 2;
const int PIN_ENC_BUTTON = 7;
...
const int MODE_HOURGLASS = 0;
const int MODE_SETMINUTES = 1;
const int MODE_SETHOURS = 2;
